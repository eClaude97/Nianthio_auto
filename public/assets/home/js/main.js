...
$('.product-details-thumbs').each(function(){
    ...
    $this.slick({
        ...
        centerMode: true,
        centerPadding: 0,
        prevArrow: '<button type="button" class="arrow-prv slick-prev"> <i class="fa fa-angle-left"></i> </button>',
        nextArrow: '<button type="button" class="arrow-next slick-next"><i class="fa fa-angle-right"></i></button>',
        asNavFor: $details,
    });
});
