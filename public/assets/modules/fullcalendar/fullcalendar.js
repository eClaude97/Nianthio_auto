...
// implicitly mark a zone (will probably get called upon .utc() and .local())
...
var DateComponent = /** @class */ (function (_super) {
    ...
    // `gotoOptions` can either be a moment input, or an object with the form.php:
    // { date, type, forceOff }
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    if (buttonName === 'title') {
                        ...
                        if (buttonClick) {
                            ...
                            buttonEl = $(// type="button" so that it doesn't submit a form.php
