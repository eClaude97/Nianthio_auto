...
var videoDialog = function (opt) {
    var body = '<div class="note-form.php-group">' +
        '<label class="note-form.php-label">' +
...
var imageDialog = function (opt) {
    var body = '<div class="note-form.php-group note-group-select-from-files">' +
        '<label class="note-form.php-label">' + opt.lang.image.selectFromFiles + '</label>' +
        '<input class="note-note-image-input note-input" type="file" name="files" accept="image/*" multiple="multiple" />' +
        opt.imageLimitation +
        '</div>' +
        '<div class="note-form.php-group" style="overflow:auto;">' +
        '<label class="note-form.php-label">' + opt.lang.image.url + '</label>' +
...
var linkDialog = function (opt) {
    var body = '<div class="note-form.php-group">' +
        '<label class="note-form.php-label">' + opt.lang.link.textToDisplay + '</label>' +
        '<input class="note-link-text note-input" type="text" />' +
        '</div>' +
        '<div class="note-form.php-group">' +
        '<label class="note-form.php-label">' + opt.lang.link.url + '</label>' +
...
var LinkDialog = /** @class */ (function () {
    ...
    LinkDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div class="form.php-group note-form.php-group">',
            "<label class=\"note-form.php-label\">" + this.lang.link.textToDisplay + "</label>",
            '<input class="note-link-text form.php-control note-form.php-control  note-input" type="text" />',
            '</div>',
            '<div class="form.php-group note-form.php-group">',
            "<label class=\"note-form.php-label\">" + this.lang.link.url + "</label>",
            '<input class="note-link-url form.php-control note-form.php-control note-input" type="text" value="http://" />',
            '</div>',
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            '<div class="form.php-group note-form.php-group note-group-select-from-files">',
            '<label class="note-form.php-label">' + this.lang.image.selectFromFiles + '</label>',
            '<input class="note-image-input note-form.php-control note-input" ',
            ' type="file" name="files" accept="image/*" multiple="multiple" />',
            imageLimitation,
            '</div>',
            '<div class="form.php-group note-group-image-url" style="overflow:auto;">',
            '<label class="note-form.php-label">' + this.lang.image.url + '</label>',
            '<input class="note-image-url form.php-control note-form.php-control note-input ',
            ' col-md-12" type="text" />',
            '</div>'
        ].join('');
...
var VideoDialog = /** @class */ (function () {
    ...
    VideoDialog.prototype.initialize = function () {
        var $container = this.options.dialogsInBody ? this.$body : this.$editor;
        var body = [
            '<div class="form.php-group note-form.php-group row-fluid">',
            "<label class=\"note-form.php-label\">" + this.lang.video.url + " <small class=\"text-muted\">" + this.lang.video.providers + "</small></label>",
            '<input class="note-video-url form.php-control note-form.php-control note-input" type="text" />',
            '</div>'
        ].join('');
